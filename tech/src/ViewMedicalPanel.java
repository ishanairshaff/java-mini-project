...
public class ViewMedicalPanel extends JPanel {
    ...
    public ViewMedicalPanel() {
        ...
        searchButton.setBackground(new Color(0, 102, 204)); // Set blue background
        searchButton.setForeground(Color.WHITE); // Set white font color
    ...
    static class MedicalRecord {
        ...
        public MedicalRecord(String medicalId, int userId, String description, String subDate, String state, String courseCode, String courseType, int cutLectureHours) {
